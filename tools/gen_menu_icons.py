...
Generates 9 category icons for the voodoo-themed top-level GIMP menus
...
Each icon targets the menubar theme it represents:
  ...
  🪆 Klein   — russian nesting voodoo doll with floating "2"
  🎭 Masks   — ornate tribal voodoo mask
...
_ICONS: list[tuple[str, str]] = [
    ...
    ("klein",
     "an ornate russian matryoshka nesting voodoo doll, carved wood "
    ...
    ("masks",
     "an ornate tribal voodoo ceremonial mask with glowing magenta "
