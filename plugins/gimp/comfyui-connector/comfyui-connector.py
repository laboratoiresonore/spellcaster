        ...
        try:
            ...
            for run_i in range(runs):
                ...
                wf["31"] = {"class_type": "KSamplerSelect",
                            "inputs": {"sampler_name": "euler"}}
                wf["32"] = {"class_type": "BasicScheduler",
                            "inputs": {"model": ["1", 0], "scheduler": "simple",
                                       "steps": steps, "denoise": denoise}}
