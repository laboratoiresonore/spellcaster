...
class InstallerApp(MagicalEffects, ctk.CTk):
    ...
    def _build_main_frames(self):
        ...
        ctk.CTkButton(nav_row, text="Skip to Review & Deploy  \u21E5", height=42,
                       font=ctk.CTkFont(family="Inter", size=14),
                       fg_color="#3A2863", hover_color="#1a1730",
    ...
    def _init_variables(self):
        ...
        for cat_key, cat_title, cat_desc, cat_features, cat_examples in _categories:
            ...
            for fkey in valid_features:
                ...
                # VRAM-aware default (force-all flag overrides to enable everything)
                _force_all = getattr(self, '_force_all_on', False)
                ...
                if vram_min > 0:
                    ...
                    ctk.CTkLabel(top_row, text=vram_badge_text,
                                 ...
                                 text_color="#12101d", fg_color="#3A2863",
    ...
    def _run_install_thread(self):
        ...
        if self.gimp_path.get():
            ...
            import json
            # Save config with installed features list (controls which menus appear)
            installed_features = [k for k, v in self.feature_vars.items() if v.get()]
            conf = {
