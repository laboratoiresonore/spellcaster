...
def build(target_platform: str, onedir: bool = False):
    ...
    cmd = [
        ...
        # Keep this list in sync with what tavern/server.py actually imports
        # from scaffold/. Dead entries add dead-weight to the .exe.
        ...
        "--hidden-import", "scaffold.spellcaster_wizard",
        "--hidden-import", "scaffold.model_activation",
        "--hidden-import", "scaffold.lora_calibration",
        "--hidden-import", "scaffold.lora_grouping",
        "--hidden-import", "scaffold.scaffold_calibration",
        "--hidden-import", "scaffold.issue_cue",
        "--hidden-import", "scaffold.cue_seeder",
        "--hidden-import", "scaffold.network_survey",
        "--hidden-import", "scaffold.install_plan",
        "--hidden-import", "scaffold.video_bridge",
        "--hidden-import", "scaffold.video_wizard",
        "--hidden-import", "scaffold.shotboard",
        "--hidden-import", "scaffold.wangp_runner",
        "--hidden-import", "scaffold.video_assembler",
        "--hidden-import", "scaffold.comfyui_runner",
        "--hidden-import", "scaffold.frame_extract",
